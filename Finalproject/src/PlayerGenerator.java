...
class PlayerGenerator {
    private static final String[] First_names = {"John", "Michael", "David", "Christopher", "James", "Daniel", "Matthew", "Andrew", "Joseph", "Joshua", "Henry", "Tom"};
    private static final String[] Last_names = {"Smith", "Johnson", "Williams", "Jones", "Brown", "Davis", "Miller", "Wilson", "Moore", "Taylor", "Brady", "Cook"};
